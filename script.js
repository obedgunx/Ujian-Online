...
document.getElementById('view-scores').addEventListener('click', function() {
    const apiUrl = 'https://script.google.com/macros/s/AKfycbyn8bRS-4l1DnZkldqRbkG6l4vfu6TuIJTpvI5pfMFRz8zdV-1tzcw6ER9alro-v-T1ng/exec?type=sheets'; // Ganti dengan URL deployment Apps Script Anda + ?type=sheets
    fetch(apiUrl)
        .then(response => response.json())
        .then(data => {
